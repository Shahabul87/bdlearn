...
export const HeroSection = () => {
  ...
  const iconHedronRef = useRef(null)
  ...
  const { scrollYProgress } = useScroll({
    target: iconHedronRef,
    offset: ['start end', 'end start'],
  });
  
  const icosahedronRotate = useTransform(scrollYProgress,[0,1],[30,-45])
  const cubeRotate = useTransform(scrollYProgress,[0,1],[150,-55])
  const torusRotate = useTransform(scrollYProgress,[0,1],[120,-120])
  const cuboidRotate = useTransform(scrollYProgress,[0,1],[50,-50])

    return (
      <section className="py-24 md:py-52 overflow-x-clip">
        <div className="container">
          <p className="uppercase font-extrabold text-center text-zinc-500 tracking-wider">Introducing Blockforge</p>
          <h1 className="font-heading font-black text-5xl md:text-6xl lg:text-7xl text-center mt-4 max-w-4xl mx-auto">The Future of Blockchain is Here.</h1>
          ...
          <div className="flex justify-center mt-24">
                <div className="inline-flex relative z-0">
                    ...
                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                     <Hexagon className="size-[1800px]" size={1800} reverse duration={50}/>
                     <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2" >
