    ...
    >
      <motion.div 
        ...
        transition={{
         ...
         className={twMerge("absolute inset-0 rounded-full outline outline-[6px] -outline-offset-[6px] outline-fuchsia-500/10 border-[6px] border-transparent", animate && "border-t-fuchsia-500/50")}></motion.div>
      {children}
    </div>
  );
};
